  ...
  return (
    <>
      ...
      <div className="container-x py-16 md:py-24">
        ...
        <Reveal>
          <div className="mt-16 grid grid-cols-[minmax(0,1fr)] gap-8 rounded-[26px] border border-line bg-surface p-7 sm:p-9 md:grid-cols-[1.3fr_1fr] md:items-center md:p-12">
