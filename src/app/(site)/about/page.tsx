  ...
  return (
    <>
      <PageHero
        ...
        title={
          <>
            Four specialists. One team. <span className="text-gradient-violet">Built for digital</span>
          </>
        }
        lead="nlogn is a four-person digital team based in Nepal, helping businesses build, improve, and grow through technology.

From websites and custom software to business systems, AI solutions, automation, SEO, and other digital services, we work across the problems that modern businesses need technology to solve.

No account managers. No unnecessary handoffs. No layers between you and the people doing the work.

The people who understand your business are the same people who design, build, and deliver the solution."
        crumbs={crumbs}
      />
