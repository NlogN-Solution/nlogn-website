...
const sections = [
  ...
  },
  {
    h: "Third parties",
    p: [
      "The site is hosted on Vercel. Transactional email is delivered through our SMTP provider. Fonts are served from Google Fonts. Page analytics, where you have accepted them, are processed by Google Analytics. Each of these processes data on our behalf under their own terms, and each may briefly see your IP address as part of delivering the page.",
    ],
  },
  {
    h: "Your rights",
  ...
  },
  {
    h: "Cookies",
    p: [
      "The website sets no advertising or tracking cookies, and nothing analytics-related loads until you accept it. On a first visit you are asked once; decline and no cookie is set, and the site behaves exactly the same.",
      "If you accept, Google Analytics sets its own cookies to tell one visit from the next. You can change your mind at any time from the Cookie settings link at the bottom of any page.",
    ],
  },
];
